...
@Repository
public class OrderMessageInMemoryRepository {

    private static final String ORDER_COMPLETED_IDEMPOTENCY_KEY = "order.completed:Idempotency";

    private final RedissonClient redissonClient;

    public OrderMessageInMemoryRepository(RedissonClient redissonClient) {
        this.redissonClient = redissonClient;
    }


    /**
     * 멱등성 키를 Redis Set 에 저장 Redis Key: "order.completed:Idempotency" Value: 실제 멱등성 키 문자열
     */
